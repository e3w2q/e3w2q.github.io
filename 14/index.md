...
- [狹ピッチ対応キーキャップを求めて - e3w2q.github.io](https://e3w2q.github.io/10/)
...
既存のキーキャップの裾の部分を削って狭ピッチキーボードで使えるようにする、という方法もあります。
...
- [狹ピッチ自作キーボード基板te96を公開しました - e3w2q.github.io](https://e3w2q.github.io/11/)
